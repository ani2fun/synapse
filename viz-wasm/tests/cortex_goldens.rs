...
use viz_wasm::engine::adapt;
use viz_wasm::engine::graph::{VizCases, VizGraph, VizStep};
use viz_wasm::engine::trace::HeapTrace;
                ...
                steps: g
                    ...
                    .map(|s| VizStep {
                        ...
                        frames: s
                            .frames
                            .iter()
                            .map(|f| viz_wasm::engine::graph::VizFrame {
                                locals: f
                                    .locals
                                    .iter()
                                    .map(|l| viz_wasm::engine::graph::VizLocal {
                                        value: String::new(),
                                        changed: false,
                                        ..l.clone()
                                    })
